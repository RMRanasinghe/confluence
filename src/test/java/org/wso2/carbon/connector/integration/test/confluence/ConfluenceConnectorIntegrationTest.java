...
public class ConfluenceConnectorIntegrationTest extends ESBIntegrationTest {
	...
	public void testLoginPositive() throws Exception {
		...
		try {
			...
			Assert.assertTrue(jsonObject.has("loginResponse"),jsonObject.toString());
		} finally {
	...
	public void testExportSite() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("exportSiteResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetClusterInformation() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getClusterInformationResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetClusterNodeStatuses() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getClusterNodeStatusesResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testisPluginEnabled() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("isPluginEnabledResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testremoveAttachment() throws Exception {
		...
		try {
			...
			Assert.assertTrue(jsonObject.has("removeAttachmentResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetAttachment() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getAttachmentResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetAttachmentData() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getAttachmentDataResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testLogout() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("logoutResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetBlogEntries() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getBlogEntriesResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetBlogEntry() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getBlogEntryResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetServerInfo() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getServerInfoResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testaddLabelByNameToSpace() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("addLabelByNameToSpaceResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetLabelContentByName() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getLabelContentByNameResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetMostPopularLabels() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getMostPopularLabelsResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetRecentlyUsedLabels() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getRecentlyUsedLabelsResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetSpacesWithLabel() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getSpacesWithLabelResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testmovePage() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("movePageResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testmovePageToTopLevel() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("movePageToTopLevelResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testremovePage() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("removePageResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetContentPermissionSets() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject
					.has("getContentPermissionSetsResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetPages() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getPagesResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetPage() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getPageResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testaddAnonymousPermissionToSpace() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject
					.has("addAnonymousPermissionToSpaceResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testaddPermissionToSpace() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("addPermissionToSpaceResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetPagePermissions() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getPagePermissionsResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetPermissions() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getPermissionsResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetPermissionsForUser() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getPermissionsForUserResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetSpaceLevelPermissions() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getSpaceLevelPermissionsResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testremoveAllPermissionsForGroup() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("removeAllPermissionsForGroupResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testremoveAnonymousPermissionFromSpace() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("removeAnonymousPermissionFromSpaceResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testremoveAnonymousPermissionFromSpaceNegative() throws Exception {
	...
	public void testremoveGlobalPermission() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("removeGlobalPermissionResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testremovePermissionFromSpace() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("removePermissionFromSpaceResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetSpace() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getSpaceResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testaddGroup() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("addGroupResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testaddUser() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("addUserResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testaddUserToGroup() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("addUserToGroupResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testchangeMyPassword() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("changeMyPasswordResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testchangeUserPassword() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("changeUserPasswordResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testdeactivateUser() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("deactivateUserResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetActiveUsers() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getActiveUsersResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetGroups() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getGroupsResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetUser() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getUserResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetUserGroups() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getUserGroupsResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testgetUserInformationGroups() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("getUserInformationResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testremoveUser() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("removeUserResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
	...
	public void testremoveUserFromGroup() throws Exception {
		...
		try {
			JSONObject jsonObject = ConnectorIntegrationUtil.sendRequest(
					getProxyServiceURL(methodName), modifiedJsonString);
			Assert.assertTrue(jsonObject.has("removeUserFromGroupResponse"),jsonObject.toString());
		} finally {
			proxyAdmin.deleteProxy(methodName);
		}
